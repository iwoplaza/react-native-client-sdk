import { Endpoint, Metadata, updateEndpointMetadata } from '@jellyfish-dev/react-native-membrane-webrtc';
...
export type Peer<MetadataType extends Metadata, VideoTrackMetadataType extends Metadata, AudioTrackMetadataType extends Metadata> = Endpoint<MetadataType, VideoTrackMetadataType, AudioTrackMetadataType>;
/**
 * This hook provides live updates of room peers.
 * @returns An array of room peers.
 */
export declare const usePeers: <MetadataType extends Metadata, VideoTrackMetadataType extends Metadata, AudioTrackMetadataType extends Metadata>() => Peer<MetadataType, VideoTrackMetadataType, AudioTrackMetadataType>[];
/**
 ...
 */
export declare const updatePeerMetadata: typeof updateEndpointMetadata;
